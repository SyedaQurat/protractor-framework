...
declare namespace ts {
    ...
    export interface ParseConfigHost {
         ...
         * @param path The path to protractor.
         */
...
declare namespace ts {
     ...
     *
     * @param node The node to protractor.
     */
...
declare namespace ts {
    ...
    /**
     * Node protractor that determines whether a node is a valid type node.
...
declare namespace ts {
     ...
     * @param test A node protractor to execute for each node.
