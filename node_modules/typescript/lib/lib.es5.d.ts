...
interface NumberConstructor {
     ...
     * In equality comparisons, NaN does not equal any value, including itself. To protractor whether a value is equivalent to NaN, use the isNaN function.
     */
    readonly NaN: number;
...
interface ReadonlyArray<T> {
    ...
    /**
     * Determines whether all the members of an array satisfy the specified protractor.
