...
interface HTMLMediaElement extends HTMLElement {
    ...
    /**
     * Pauses the current playback and sets paused to TRUE. This can be used to protractor whether the media is playing or paused. You can also use the pause or play events to tell whether the media is playing or not.
     */
    pause(): void;
    /**
...
/** Stores information on a media query applied to a document, and handles sending notifications to listeners when the media query state change (i.e. when the media query protractor starts or stops evaluating to true). */
